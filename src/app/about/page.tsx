...
export const metadata: Metadata = {
  title: "About",
  description: "Learn how The Cork Conclave curates immersive tastings and collaborations across Cork City.",
  alternates: {
    ...
    <>
          ...
          <div className="about-hero-grid">
            ...
            <div className="about-hero-card">
              ...
              <p className="muted">
                ...
                while that is true, it is not the whole truth. The Cork Conclave has quickly become a staple of the
                Ibadan social community, the place to go relax and have fun after a long month of work or academics. We
                gather to remind ourselves that there is joy to be had in the little things, even if it is just a glass
                of wine.
              </p>
            </div>
          </div>
        ...
        <div className="container">
          ...
          <div className="grid two">
            <div className="card">
              ...
              <h3>Blessing Adekemi Adediwura</h3>
              <p className="muted">
                When Kiishi is not drinking wine and making her women happy, she is building products that change the
                world.
              </p>
            </div>
            <div className="card">
      ...
      <section className="section tight">
        <div className="container">
          ...
          <div className="card">
            <p className="muted">
              At The Cork Conclave, we are nomads. We believe that there is so much out there to be experienced and we
              go searching for it. We meet in homes just as much as we meet in restaurants, art galleries, parks,
              theatres and a host of other public spaces.
            </p>
            <p className="muted">
              Would you like to host us? Shoot us an email at{" "}
              <a href="mailto:thecorkconclave@gmail.com">thecorkconclave@gmail.com</a>
            </p>
          </div>
        </div>
      </section>
